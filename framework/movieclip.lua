...
function newAnim (imageTable)
	...
	local function nextFrame( self, event )
		...
		g.currentImg = animFrames[currentFrame];
	end
	...
	function g:enterFrame( event )
		animFrames[0].counter = animFrames[0].counter + 1 -- Increment frame counter
	...
	function g:play( fps, params )
		animFrames[0] = {} -- Uses redundant index of zero to store play speed info for each object as it is created
